...
final class GameModel: ObservableObject {
    ...
    private let totalKeysStorageKey = "earthnaru.totalKeys"
    ...
    func applyRemoteTotal(_ remoteTotal: Int) {
        let oldLevel = level
        totalKeys = max(totalKeys, remoteTotal)
    ...
    func addLocalKeyForTesting() {
        applyRemoteTotal(totalKeys + 1)
    }
